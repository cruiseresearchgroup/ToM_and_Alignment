...
def train(probe, label, device, train_loader, optimizer, epoch, loss_func, 
...
def test(probe, label, device, test_loader, loss_func, return_raw_outputs=False, verbose=True,
