...
class GPT3BaseAgentAIML(BaseAgent):
    def __init__(self, kwargs: dict):
        self.args = SimpleNamespace(**kwargs)
        self._set_default_args()
        self.client = OpenAI(base_url="http://api.aimlapi.com/v1", api_key=os.getenv('AIML_API_KEY'))

    def _set_default_args(self):
        if not hasattr(self.args, 'model'):
            self.args.model = "meta-llama/Llama-3.2-3B-Instruct-Turbo"
...
class ConversationalGPTBaseAgentAIML(GPT3BaseAgentAIML):
    def __init__(self, kwargs: dict):
...
class AsyncConversationalGPTBaseAgentAIML(ConversationalGPTBaseAgentAIML):
    def __init__(self, kwargs: dict):
        super().__init__(kwargs)
        self._set_default_args()
        self.client = AsyncOpenAI(base_url="http://api.aimlapi.com/v1", api_key=os.getenv('AIML_API_KEY'))
