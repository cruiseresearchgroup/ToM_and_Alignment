...
from .aiml import GPT3BaseAgentAIML, AsyncConversationalGPTBaseAgentAIML
...
def load_model(model_name, **kwargs):
    if model_name.startswith("text-"):
        ...
        model = AsyncConversationalGPTBaseAgentAIML({'model': model_name, 'temperature': 0, 'top_p': 1.0, 'frequency_penalty': 0.0, 'presence_penalty': 0.0})
